        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Matches_Members_PlayerOneId",
                        column: x => x.PlayerOneId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Members_PlayerTwoId",
                    ...
                    table.ForeignKey(
                        name: "FK_Matches_Tracks_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ScorePlayerOne = table.Column<int>(type: "int", nullable: false),
                    ScorePlayerTwo = table.Column<int>(type: "int", nullable: false),
